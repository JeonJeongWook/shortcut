...
>
>   ![win_taskbar](./img/win_taskbar.png)
...
>   |**[win] + [E]**|파일 탐색기 실행 <sub>( [**내 PC** / **즐겨찾기**] 변경 가능)<br>(폴더 → [보기] 탭 → 옵션 → 폴더 및 검색 옵션 → [일반] 탭 → 파일 탐색기 열기)</sub>|
>   |**[win] + [L]**|화면 잠금|
>   |**[win] + [P]**|디스플레이 설정<sub>( 듀얼 모니터일 경우 사용 )<br>(pc화면 / 복제 / 확장 / 두번째 화면만 선택)</sub>|
>   |**[win] + [R]**|실행창<br><sub>사용 가능 명령어 : cmd, regedit, magnify, control, calc, notepad, mspaint</sub>|
...
>   |문서 작업 시 **[Ctrl]** 누르고 **좌우 방향키** 입력시 단어 단위로 이동|
